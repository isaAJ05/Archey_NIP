...
//        error2v.setVisible(false);
    ...
    private void initComponents() {
        ...
        PanelVentas.add(BuscadorVentas, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 95, 380, 30));
...
//        );
    ...
    private void BuscadorEmpleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscadorEmpleActionPerformed
        String valorBuscado = BuscadorEmple.getText().toLowerCase();
        ...
        if (coincidenciaEncontrada == true) {
            ...
            MostrarBusquedaEmple.setVisible(false);
